...
from storyflow_nodes import (
    ...
    ReviseNode,
    # 5-Agent
    storyflowWorkflow, RadarNode, ArchitectNode, WriterNode
)
...
async def test_full_storyflow_workflow():
    """测试完整的 storyflow 5-Agent 工作流"""
    print("\n" + "="*60)
    print("🚀 测试 storyflow 5-Agent 完整工作流")
    print("="*60)
    ...
    print("\n✅ storyflow 5-Agent 工作流测试完成")


def main():
    print("\n" + "="*60)
    print("🎯 StoryFlow storyflow 增强节点测试")
    print("="*60)
    ...
    asyncio.run(test_full_storyflow_workflow())
