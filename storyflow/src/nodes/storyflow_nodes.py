...
# ============================================================
# storyflow 5-Agent 工作流类
# ============================================================

class storyflowWorkflow:
    ...
    def _create_agents(self):
        ...
        # 构建工作流
        self.workflow = Workflow("storyflow_5agent", "storyflow 5-Agent")
...
def create_storyflow_node(node_type: str, node_id: str, **kwargs) -> Node:
    """根据类型创建 storyflow 节点"""
    node_class = storyflow_NODE_REGISTRY.get(node_type)
    if not node_class:
        raise ValueError(f"未知的 storyflow 节点类型: {node_type}")
