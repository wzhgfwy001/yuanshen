...
**触发场景：**
- 用户说"帮我找AI专家"、"我要一个安全工程师"、"激活某领域的专家" → 自动调用此Skill
- 用户提到具体专家角色（如"小红书运营专家"、"前端专家"、"产品经理"）
- 用户要求"多智能体协作"、"多个专家一起工作"

**示例对话：**
- 用户："我需要一个后端专家帮我设计API"
- AI自动激活 Backend Expert，提供API设计方案

- 用户："创建一个新功能，需要产品经理和开发工程师协作"
- AI自动协调 Product Manager + Frontend/Backend Expert 联合工作

- 用户："小红书笔记怎么写"
- AI自动激活 小红书运营专家，提供种草笔记写作指导

**不适用场景：**
- 简单问答不需要此Skill（如"今天天气怎么样"）
- 单一任务且无需专家角色（如"帮我算一下1+1"）
