...
**触发场景：**
- 用户问"有哪些功能"、"功能开关"、"feature flags" → 自动调用此Skill
- 用户说"启用XX功能"、"关闭XX功能"、"开启XX" → 自动调用此Skill
- 用户说"查看功能状态"、"看看哪些功能开了" → 自动调用此Skill

**示例对话：**
- 用户："有哪些功能可以开启？"
- AI自动使用此Skill列出所有功能及其状态

- 用户："帮我开启主动建议功能"
- AI自动使用此Skill启用 `proactive_suggest` 特性

- 用户："关闭语音模式"
- AI自动使用此Skill禁用 `voice_mode` 特性

**不适用场景：**
- 简单问答不需要此Skill（如"现在几点"、"天气怎样"）
- 常规任务执行不需要开关控制
